			...
			<div id="navigation">
				<div id="menu">
					...
					<form class="searchform" action="#">
						...
						<input class="searchfield" type="text" value="Suchen..." onfocus="if (this.value == 'Search...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search...';}" />
					</form>
					<!-- / Search Form -->
